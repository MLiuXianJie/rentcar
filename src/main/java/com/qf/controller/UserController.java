...
public class UserController {
    ...
    public  User  updateEmail(User user){
        User userByEmail = userServer.getUserByEmail(user.getEmail());
        if(userByEmail==null){
            Integer integer = userServer.updateEmail(user.getEmail(),user.getId());
    ...
    public  User  updatePWD(User user){
        User userByPWD = userServer.getUserByPWD(user.getPassword());
        if(userByPWD==null){
